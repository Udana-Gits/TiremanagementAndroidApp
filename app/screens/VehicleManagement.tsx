...
const VehicleManagement: React.FC<Props> = ({ navigation }) => {
    ...
    return (
        ...
        >
            <View style={[styles.container, isDarkMode ? styles.darkcontainer : styles.lightcontainer]} >
                ...
                <Text style={[styles.header, isDarkMode ? styles.darkModeText : styles.lightModeText]}>Vehicle Management</Text>
                    <View style={styles.buttonContainer}>
                        ...
                        <Image source={isDarkMode ? require('./images/truckdark.png') : require('./images/trucklight.png')} style={styles.buttonImage} />
